...
@section('content')
    ...
    <div class="w-full px-8 md:px-32 lg:px-24">
        ...
        <form class="bg-white rounded-md shadow-2xl p-5" action="{{ route( 'admin.competitions.update', $competition) }}" method="Post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
                <input id="name" class=" pl-2 w-full outline-none border-none" type="text" name="name" value="{{$competition->name}}" />
            </div>
